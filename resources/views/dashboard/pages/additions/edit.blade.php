        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data"
                    action="{{ route('additions.update',$item->id) }}">
                    @csrf
                    @method('put')
                    <div class="card-body">
                            ...
                            @foreach ($colors as $color)
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="color_id[]"
                                        ...
                                        {{ $item->colors->contains($color->id) ? 'checked' : '' }}>
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    @foreach ($item->images as $image)
                                        <img src="{{ asset('images/Addition/' . $image->image) }}" width="100"
                                            height="100">
                                    @endforeach
                                </div>
                                @error('image')
                        ...
                        <div class="card-body">
                            ...
                            <div class="m-b-30">
                                <form action="#" class="dropzone">
                                    <div class="fallback">
                                        <img >
                                        <img src="{{ asset('images/Addition/' . $item->image) }}" width="100" height="100">
