                ...
                <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Address</label>
                            <div>
                                <textarea name="address" class="form-control"  rows="5" placeholder="address">{{ $item->address }}</textarea>
                        ...
                        <div class="form-group">
                            <label>Map</label>
                            <input type="text" name="map" class="form-control"  placeholder="map" value="{{ $item->map }}"/>
                            @error('map')
                                <div style="color: red">{{ $message }}</div>
                            @enderror
                        </div>  
                         <div class="form-group">
                            <label>Fax</label>
                            <input type="text" name="fax" class="form-control"  placeholder="fax" value="{{ $item->fax }}"/>
                            @error('fax')
                                <div style="color: red">{{ $message }}</div>
                            @enderror
                        </div>   
