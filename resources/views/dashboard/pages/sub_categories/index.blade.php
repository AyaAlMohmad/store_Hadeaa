                                  ...
                                  <td> <img src="{{ asset('images/subcategory/' . $data->image) }}" width="100" height="100"></td>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons" style="display:flex;">
                                            <a style="color:green" href="{{ route('sub_categories.edit', $data->id) }}">
                                                <i class="fas fa-feather bigger-120" style="margin-right: 10px;"> </i>
                                            </a>
                                            <a style="color:blue" href="{{ route('sub_categories.show', $data->id) }}">
                                                <i class="dripicons-zoom-in bigger-120" style="margin-right: 10px;"></i>
                                            </a>
                                            <form method="POST" action="{{ route('sub_categories.destroy', $data->id) }}">
                                                @csrf
                                                @method('DELETE')
