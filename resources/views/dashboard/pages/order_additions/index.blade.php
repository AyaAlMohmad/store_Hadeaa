                                        ...
                                        @foreach ($items as $data)
                                            <tr>
                                                        ...
                                                        <div class="container-fluid">
                                                            ...
                                                            <div class="row text-center">
                                                                <div class="col-sm-6 col-md-4 col-xl-3 m-b-30">
                                                                    ...
                                                                    data-product-name="{{ $data->addition->name }}"
                                                                    data-product-image="{{ asset('images/Addition/' . $data->addition->image) }}">
                                                                    {{ $data->user->name }}
                                                                    </button>
                                                ...
                                                <td><img style="width: 90px; height: 90px;"
                                                        src="{{ asset('images/Addition/' . $data->addition->image) }}">
                                                </td> 
                                                <td>
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons" style="display:flex;">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('order_additions.destroy', $data->id) }}">
                                                            @csrf
                                                            @method('DELETE')
